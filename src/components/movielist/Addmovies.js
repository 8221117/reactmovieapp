...
const Addmovieform = ({user, parentfn}) => {
    ...
    return (
        <div>
            <form>
                <TextField id="standard-basic" label="MovieName" variant="standard" type="text" name="moviename"
                           value={moviename} onChange={addName}/>
                {/* MovieName:<input type="text" name="moviename" value={moviename} onChange={addName}></input> */}
                <br></br>
                <TextField id="standard-basic" label="Rating" variant="standard" type="number" step="any" name="rating"
                ...
                <br></br>
                <TextField id="standard-basic" label="Summary" variant="standard" type="text" name="summary"
                ...
                <br></br>
                <TextField id="standard-basic" label="PosterLink" variant="standard" type="text" name="poster"
                           value={poster} onChange={(e) => {
                    setPoster(e.target.value)
                }}/>
                {/* PosterLink:<input type="text" name="poster" value={poster} onChange={(e)=>{setPoster(e.target.value)}}></input> */}
                <br></br>
                <TextField id="standard-basic" label="TrailerLink" variant="standard" type="text" name="trailer"
                           value={trailer} onChange={(e) => {
